...
export default function EmployerProfileUpdateForm({
  ...
  const submitBasicDetails = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || err.message || "Error updating basic details");
    } finally {
  ...
  const submitEmployerDetails = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || err.message || "Error updating employer profile");
    } finally {
